  ...
  describe "users" do
    ...
    setup do
     ...
     update_attrs = %{
      ...
      # making these structs available to all tests at runtime
      {:ok,
        %{
    ...
    test "update_user/2 with valid data updates the user",
         %{valid_attrs: valid_attrs, update_attrs: update_attrs} do
      user = user_fixture(valid_attrs)
    ...
    test "update_user/2 with invalid data returns error changeset",
         %{valid_attrs: valid_attrs, invalid_attrs: invalid_attrs}do
      user = user_fixture(valid_attrs)
